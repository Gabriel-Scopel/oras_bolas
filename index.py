...
def MovRoboXY2(t2i, xri2, yri2, trajbola, tempo, SxRobo, SyRobo, VxRobo, VyRobo, AxRobo, AyRobo):
    ...
    for i in range(t2i, 1001):
        ...
        if RaioInterceptação(SRoboX , SRoboY, tempo[i], trajbola) == 1:
            ...
            pass
    return Tencontro, SxRobo, SyRobo, VxRobo, VyRobo, AxRobo, AyRobo
    ...
    for i in range(0, 1001):
        ...
        if tpara>=1:
            ...
            if RaioInterceptação(SRoboX , SRoboY, tempo[i], trajbola) == 1:
                ...
                pass
    if Tencontro == 0:
        Tencontro, SxRobo, SyRobo, VxRobo, VyRobo, AxRobo, AyRobo = MovRoboXY2(t2i, xri2, yri2, trajbola, tempo, SxRobo, SyRobo, VxRobo, VyRobo, AxRobo, AyRobo)
    else:
        pass
    return Tencontro, SxRobo, SyRobo, VxRobo, VyRobo, AxRobo, AyRobo
...
def SBolaXY(tempo, Tfinal):
    contador = 0
    SxBola=[]
    SyBola=[]
    for i in range(len(tempo)):
        if Tfinal == float(tempo[i]):
            contador = i
            break
